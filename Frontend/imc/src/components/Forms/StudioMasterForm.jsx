  ...
  export default function StudioMasterForm({ defaultTab = "ADD", onSaved } = {}) {
    ...
    const submit = async (e) => {
      ...
      try {
        ...
        if (editingId) {
          // UPDATE – does not touch existing images
    ...
    const deleteImage = async (studioId, imageId) => {
      ...
      try {
        ...
        // Update edit form images if we are editing this studio
      ...
      <div className="sm-card">
        <div className="sm-head">
          ...
          <div className="sm-actions">
            ...
            <button
              className={`pill ${tab === "VIEW" ? "active" : ""}`}
              onClick={() => setTab("VIEW")}
            >
        ...
        {tab === "ADD" && (
          <form className="sm-form" onSubmit={submit}>
            <div className="grid two">
              ...
              {/* === EDIT FORM: EXISTING IMAGES WITH DELETE + PREVIEW === */}
              {editingId && (
              ...
              <div className="field" style={{ gridColumn: "1 / -1" }}>
                ...
                >
                  You can select multiple images; they will be uploaded after the studio
                  is saved.
                </div>
              </div>
            </div>
                      ...
                      <tr key={r.id}>
                        ...
                        <td>
                          <div className="action-buttons">
                            ...
                            <button className="delete-btn" onClick={() => deleteRow(r.id)}>
                              Delete
                            </button>
                          </div>
                        </td>
