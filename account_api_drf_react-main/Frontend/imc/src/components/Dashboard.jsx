...
const prettyTitle = (k) => {
  ...
  const map = {
    ...
    addEquipment: "Add Equipment", viewEquipment: "View Equipment",
    addEvent: "Add Event", viewEvent: "View Events",
    addShow: "Add Show", viewShow: "View Shows",
    addPrivate: "Add Private Booking", viewPrivate: "View Private Bookings",
    addPhotography: "Add Photography Booking", viewPhotography: "View Photography Bookings",
    addVideography: "Add Videography Booking", viewVideography: "View Videography Bookings",
    addSound: "Add Sound Job", viewSound: "View Sound Jobs",
