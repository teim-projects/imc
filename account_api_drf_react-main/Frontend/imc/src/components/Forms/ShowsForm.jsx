...
const API_URL = "http://127.0.0.1:8000/api/auth/shows/";
                  ...
                  <tbody>
                    {paged.map((it) => (
                      <tr key={it.id}>
                        ...
                        <td className="right">
                          <button className="mini" onClick={() => handleEdit(it)}>✏️ Edit</button>
                          <button className="mini danger" onClick={() => handleDelete(it.id)}>🗑 Delete</button>
                        </td>
                      </tr>
                    ))}
                  </tbody>
