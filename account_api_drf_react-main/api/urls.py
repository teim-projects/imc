...
from .views import (
    ...
    # Core CRM modules
    EventViewSet, ShowViewSet, PaymentViewSet, PrivateBookingViewSet,
...
# ============== Equipment (master + rentals + flat UI) ==============
...
router.register(r"auth/equipment", EquipmentEntryViewSet, basename="auth-equipment")  # alias
